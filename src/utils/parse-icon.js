...
/**
 * Parse the icon React component into a string.
 *
 * @param {Object} icon The icon as a React object.
 * @return {string}   The icons as an HTML string.
 */
export function parseIconComponent( icon ) {
